...
;~ driver.addargument("--start-minimized") ; 창 최소화 하기 단, 처음 만들때만 적용됨 창을 연 뒤에는 적용 안됨



;~ driver.Get("http://duckduckgo.com/") ; 창 열기
driver.Get("https://vendoradmin.fashiongo.net") ; 창 열기
driver.refresh()
driver.Get("https://admin.lashowroom.com") ; 창 열기
