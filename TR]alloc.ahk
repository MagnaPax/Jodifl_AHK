...
;	MsgBox, 262144, Title, 스타일별로 정렬하기
	...
	; 현재 열려있는 파일 이름 얻기
	fileName := ComObjActive("Excel.Application").ActiveWorkbook.Name	
	
	; 현재 열려있는 파일의 경로 얻기
	path := ComObjActive("Excel.Application").ActiveWorkbook.Path
	
	; 파일 이름에서 .을 포함한 xls확장자를 제거
