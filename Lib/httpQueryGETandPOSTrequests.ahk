...
; Language:           English
; Author:             derRaphael
; Short description:  Gets Elements from Web site
; Initial Upload:     Jul 08 2008 10:58 AM
; version:            0.3.6
; https://autohotkey.com/board/topic/30624-function-httpquery-get-and-post-requests-update-036/


/*
html := httpQUERY(URL:="http://vendoradmin2.fashiongo.net/OrderDetails.aspx?po=MTR47CEFB0C")
MsgBox, % html
