...
;MsgBox % UrlGetContents("http://vendoradmin2.fashiongo.net/OrderDetails.aspx?po=MTR47CEFB0C")
;MsgBox % UrlGetContents("http:www.naver.com")
WININET_UnInit()
return
*/
...
MsgBox % UrlGetContents("http://vendoradmin2.fashiongo.net/OrderDetails.aspx?po=MTR47CEFB0C", "customer3", "Jo123456789")
